...
<input id="hf" type="hidden" value="<%=session.getAttribute("usuario")%>">
	...
	{
    	var x = <%=request.getAttribute("loginError")%>
    	
    	if(x)
    		{
		    		errorAlert("Error al iniciar sesion","Ingrese un usuario y/o contraseña validos");
